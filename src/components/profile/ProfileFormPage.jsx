// src/components/profile/ModernProfilePage.jsx (Updated Profile Display)
...
const fallbackUser = {
  ...
  grade: "Not set",
  phone: "Not set",
  parentsPhone: "Not set",
  familyIncome: "Not set",
  ...
  useEffect(() => {
    ...
    const merged = {
      ...
      email:
        ...
        mongo.email ||
        "Not set",
      phone: mongo.phone || "Not set",
      parentsPhone: mongo.parentsPhone || "Not set",
      familyIncome: mongo.familyIncome || "Not set",
        ...
        <Card className="rounded-2xl shadow-md">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-4 rounded-xl bg-gray-50">
              ...
              <p className="text-lg font-semibold">{userState.phone}</p>
            </div>
            <div className="p-4 rounded-xl bg-gray-50">
              <div className="flex items-center gap-3 mb-2">
                <Phone className="h-5 w-5 text-gray-600" />
                <span className="text-sm font-medium text-gray-700">Parents Phone</span>
              </div>
              <p className="text-lg font-semibold">{userState.parentsPhone}</p>
            </div>
            <div className="p-4 rounded-xl bg-gray-50">
              <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-lg font-semibold">{userState.school}</p>
            </div>
            <div className="p-4 rounded-xl bg-gray-50">
              <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-lg font-semibold">{userState.familyIncome}</p>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="bg-white rounded-2xl shadow-lg w-full max-w-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium">Parents Phone</label>
                  <input
                    name="parentsPhone"
              ...
              <div>
                ...
                >
                  ...
                  <option value="< 2 Lakh">Less than 2 Lakh</option>
